...
public class FollowMeManagerImpl implements FollowMeAdministration {
	...
	**/
	...
	public IlluminanceGoal getUserPreference(String name) {
	...
	public void setUserPreference(String name, IlluminanceGoal illuminanceGoal) {
		PreferencesService.setUserPropertyValue(name, USER_PROP_ILLUMINANCE, illuminanceGoal);
	}
